<cfcomponent persistent="true" table="contacts" output="false">
    ...
    <cfproperty name="firstName" column="first_name" type="string" length="100" required="true" notnull="true">
    <cfproperty name="lastName" column="last_name" type="string" length="100" required="true" notnull="true">
